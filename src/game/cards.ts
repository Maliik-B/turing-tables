...
export const CARDS: Record<string, CardDef> = {
  ...
  ping: {
    ...
    cost: 1,
    type: 'attack',
    text: 'Deal 4 damage. Returns to your hand.',
    damage: 4,
    resummon: true,
  },
  heavy: {
  ...
  leech: {
    ...
    cost: 2,
    type: 'attack',
    text: 'Deal 10 damage. Heal half the damage dealt.',
    damage: 10,
    drains: true,
  },
  defend: {
  ...
  cascade: {
    ...
    cost: 0,
    type: 'attack',
    text: "Deal 3 damage. Deal 7 instead if you've already attacked this turn.",
    damage: 3,
    followup: 4,
  },
  riposte: {
